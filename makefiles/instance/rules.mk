...
ALL_PURE_OBJCFLAGS = $(call __schema_var_all,$(THEOS_CURRENT_INSTANCE)_PURE_,OBJCFLAGS)
...
$(THEOS_OBJ_DIR)/%.m.$(_THEOS_OBJ_FILE_TAG).o: %.m
	...
	$(ECHO_COMPILING)$(ECHO_UNBUFFERED)$(TARGET_CXX) -x objective-c -c $(_THEOS_INTERNAL_IFLAGS_C) $(ALL_DEPFLAGS) $(ALL_CFLAGS) $(ALL_OBJCFLAGS) $(_THEOS_TARGET_ONLY_OBJCFLAGS) $(ALL_PURE_OBJCFLAGS) $< -o $@$(ECHO_END)
